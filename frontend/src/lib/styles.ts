...
export const summaryCardClass =
  "grid min-h-28 gap-1.5 border border-sky-200 bg-white p-4 shadow-sm shadow-sky-100";
...
// フォーム入力（HomePage の支払いカード選択と、Login/Register の入力フィールドで共通）
...
// 認証ページ（Login / Register）で共通
export const authFormClass =
  "grid gap-4 border border-sky-200 bg-white p-6 shadow-sm shadow-sky-100";
export const authLinkClass = "font-semibold text-sky-700 hover:text-sky-900";
